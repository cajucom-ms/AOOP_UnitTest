...
public class AdminAccounting extends JFrame {
    ...
    public AdminAccounting(User user) {
    ...
    private void updateLabels() {
        if (loggedInUser != null) {
            ...
            lblWelcomeMessage.setText("Dashboard");
    ...
    new PayrollManagement(loggedInUser).setVisible(true);
    this.dispose();//closes window after the button was clicked
