...
/**
 * Enhanced HR Model Class - extends EmployeeModel and integrates with Services layer
...
public class HRModel extends EmployeeModel {
    ...
    /**
     * Constructor for HR role
     */
    public HRModel(int employeeId, String firstName, String lastName, String email, String userRole) {
     ...
     */
    public HRModel(EmployeeModel employee) {
        super();
        this.copyFromEmployeeModel(employee);
        
        // Initialize HR-specific components
        DatabaseConnection dbConnection = new DatabaseConnection();
        this.payrollService = new PayrollService(dbConnection);
        this.attendanceService = new AttendanceService(dbConnection);
        this.leaveService = new LeaveService(dbConnection);
        ...
        System.out.println("HR user initialized from EmployeeModel: " + getFullName());
    }
