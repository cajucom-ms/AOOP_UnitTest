...
public class EmployeeDAO extends BaseDAO<EmployeeModel, Integer> {
    ...
    public EmployeeModel validateCredentials(String email, String passwordHash) {
        ...
        String sql = "SELECT * FROM employee WHERE email = ? AND passwordHash = ? AND status != ?";
        return executeSingleQuery(sql, email, passwordHash, EmployeeStatus.TERMINATED.getValue());
    }
    ...
    public boolean save(EmployeeModel employee) {
        if (employee == null) {
            System.err.println("DEBUG: Cannot save null employee");
            return false;
        }
        ...
        if (employee.getFirstName() == null || employee.getFirstName().trim().isEmpty() ||
            ...
            System.err.println("  Email: " + employee.getEmail());
        ...
        try (Connection conn = databaseConnection.createConnection();
            ...
            System.err.println("DEBUG: SQL Error in save: " + e.getMessage());
